...
import { SixPlayersLayout1 } from "../components/game-layouts/six/six-players-layout-1";
import { SixPlayersLayout2 } from "../components/game-layouts/six/six-players-layout-2";
...
export const layouts = {
  ...
  6: [SixPlayersLayout1, SixPlayersLayout2],
};
